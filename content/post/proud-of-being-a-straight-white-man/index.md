---
title: "Proud of being a straight, white man"
date: 2013-09-18T00:00:11
slug: "proud-of-being-a-straight-white-man"
image: "wasp.png"
categories:
  - "Equality"
  - "Ethics"
...
[caption id="attachment\_352" align="aligncenter" width="394" class=" "][![Slave being whipped in colonial Brazil](/uploads/2013/09/escravo.webp)](/uploads/2013/09/escravo.webp) Slave being whipped in colonial Brazil[/caption]

Even after slavery was abolished there continued to be social segregation which, although it has improved, it hasn’t been completely eliminated. To reinforce and illustrate my point, I suggest an interesting article: [Timeline of the African-American Civil Rights Movement](https://en.wikipedia.org/wiki/Timeline_of_the_African-American_Civil_Rights_Movement). It is remarkable to see that *de jure* (official, permitted by law) racial segregation in the USA was only completely eradicated at the national level with the [Civil Rights Act of 1964](http://en.wikipedia.org/wiki/Civil_Rights_Act_of_1964). Before that, racial segregation was not only allowed but sometimes even official, as in the case of the [Jim Crow laws](http://en.wikipedia.org/wiki/Jim_Crow_laws). I know I’ve written the year already, but I feel I have to say again: nineteen SIXTYFOUR. This was YESTERDAY. And there is more: earlier that year three activists associated to [CORE (Congress of Racial Equality)](http://en.wikipedia.org/wiki/Congress_of_Racial_Equality) were assassinated by the [White Knights of the Ku Klux Klan](http://en.wikipedia.org/wiki/White_Knights_of_the_Ku_Klux_Klan). Just to give an idea about the context and how “welcomed” these changes were.

Regarding Brazil, everything seems to point to the fact that after the abolition of slavery there was no more *de jure* discrimination against the black population. This doesn’t mean that they had a similar status to white people, however. From the [Tribunal Superior Eleitoral's website](http://www.tse.jus.br/noticias-tse/2013/Abril/serie-inclusao-antes-excluidos-hoje-indios-e-negros-participam-ativamente-do-processo-eleitoral) (my translation):
...
Even today, this [hasn't been solved](http://pt.wikipedia.org/wiki/Racismo_no_Brasil). A table taken from Wikipedia which illustrates the status of black people in Brazilian society is this:

> | Indices | White Brazilian | Black Brazilian |
> | --- | --- | --- |
> | [Illiteracy](http://pt.wikipedia.org/wiki/Analfabetismo "Analfabetismo")[7](http://pt.wikipedia.org/wiki/Racismo_no_Brasil#cite_note-7) | 5,9% | 13,3% |
> | [University educatio](http://pt.wikipedia.org/wiki/Grau_acad%C3%AAmico "Grau acadêmico")n[8](http://pt.wikipedia.org/wiki/Racismo_no_Brasil#cite_note-8) | 15,0% | 4,7% |
> | [Life expectancy](http://pt.wikipedia.org/wiki/Expectativa_de_vida "Expectativa de vida")[9](http://pt.wikipedia.org/wiki/Racismo_no_Brasil#cite_note-9) | 73,13 | 67,03 |
> | [Unemployment](http://pt.wikipedia.org/wiki/Desemprego "Desemprego")[10](http://pt.wikipedia.org/wiki/Racismo_no_Brasil#cite_note-10) | 5,7% | 7,1% |
> | [GDP per capita](http://pt.wikipedia.org/wiki/PIB_per_capita "PIB per capita")[11](http://pt.wikipedia.org/wiki/Racismo_no_Brasil#cite_note-11) | R$ 22,699 | R$ 15,068 |
> | [Death by homicide](http://pt.wikipedia.org/wiki/Homic%C3%ADdios "Homicídios")[12](http://pt.wikipedia.org/wiki/Racismo_no_Brasil#cite_note-12) | 29,24% | 64,09% |
...
- In 1999 in the US, 1218 women and 424 men were killed by their partners. The numbers for 2005 were 1181 and 329, respectively. In England and Wales around 100 women are killed by their spouse or ex-spouse every year, while the number of men who died in the same way was 21 in 2010. The topic is more developed on [Wikipedia](http://en.wikipedia.org/wiki/Domestic_violence#Violence_against_women), which also offers citations for these statistics.
- Nature hasn’t been very merciful to the human female. It made them shorter, less muscular and gave them a vagina while it gave men a penis which gets hard. In other words, it gave men the power to rape. And what do many men do? Rape. There were around 35,000 cases in the [war in Bosnia](http://en.wikipedia.org/wiki/Rape_in_the_Bosnian_War) only, in a terrifying episode of history, which is remembered as “mass rape”. And what do authorities do about it? In developed countries they protect women. In other countries, like Malaysia, [the rapist can](http://www.huffingtonpost.com/2013/05/22/malaysian-man-rape-marries-victim_n_3321086.html)[marry the victim](http://www.huffingtonpost.com/2013/05/22/malaysian-man-rape-marries-victim_n_3321086.html). Even in some western developing countries, like Chile, a woman doesn’t have the right to an abortion even if she is a rape victim.

I am citing different statistics for each “minority”, but many of them apply to more than one category. The following illustrates this point:

Workplace discrimination
[caption id="attachment\_862" align="aligncenter" width="595"][![pay-gap](/uploads/2013/09/pay-gap.png)](/uploads/2013/09/pay-gap.png) [Difference between the salaries of men and women in some groups in the US](https://en.wikipedia.org/wiki/Gender_pay_gap_in_the_United_States#/media/File:US_gender_pay_gap,_by_sex,_race-ethnicity-2009.png)[/caption]

In other words, after a history of female absence from power positions, academia, or any intellectual and business environment for that matter, it is obvious that there is a ***stigma***(what do you know, here’s the word again!) associated to women which keeps them in an inferior position in society. This can be seen in their salaries and unequal employment, not only on the labor market but also in the academic environments, where one could expect people to be more “enlightened”. In a [Yale experiment](http://blogs.scientificamerican.com/unofficial-prognosis/2012/09/23/study-shows-gender-bias-in-science-is-real-heres-why-it-matters/), academic researchers were given the same application for a job as lab manager. Half of them received the applications with male names and the other half with female names. Results showed that the women “candidates” had significantly lower classifications in terms of competency, how likely they were to be hired and the researchers’ willingness to mentor them.
...
| --- |
|  |
| Women [protest against sexism in media](http://www.theguardian.com/media/2012/nov/27/women-fighting-sexism-media-page-3) in London |
...
And how's the situation today? Homosexuality is illegal in [mais de 70 países](https://en.wikipedia.org/wiki/LGBT_rights_by_country_or_territory). The punishment goes all the way to death sentence in 9 countries, prison in over 40, in others it's only fines, deportation and forced labor, and in the other countries, where it's legal to be gay, they're just beat up by skinheads and target for [hate speech](https://en.wikipedia.org/wiki/Hate_speech).

|  |
| --- |
|  |
| [Westboro Baptist Church](https://en.wikipedia.org/wiki/Westboro_Baptist_Church) is (in)famous for its protests at the funeral of gay people killed by homophobes and of other minorities that they judge to be "hated by God" according to Biblical passages. |
...
Expressions of male, white, heterosexual pride, on the other hand, transmit nothing but a negative attitude of legitimation and securing of their superior position in the social hierarchy. Black, gay women want their image to be as positive as that of straight, white men. What about the straight, white men? What is it that they want?

– Translated from Portuguese on Sep 2, 2014
